  ...
  return (
    <div name="home" className="h-screen flex flex-col justify-center">
      <div className="max-w-3xl">
        ...
        <h2 className="text-2xl sm:text-5xl font-bold text-darkText mb-6">
        ...
        <div className="flex gap-4">
          <a
            href="/resume.pdf"
            className="group border-2 border-secondary text-accent px-6 py-3 flex items-center hover:bg-secondary hover:text-primary duration-300"
          >
            View Resume
          </a>
          <Link
